...
function upload_space_setting( $id ) {
	...
	<tr>
		...
		<td>
			<input type="number" step="0.1" min="0" style="width: 100px" name="option[blog_upload_space]" id="blog-upload-space-number" aria-describedby="blog-upload-space-desc" value="<?php echo $quota; ?>" />
