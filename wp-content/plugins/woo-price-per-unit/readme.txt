...
== Description ==
ANNOUNCEMENT: No new features will be created in free version anymore, only bugfixes. I'm directing my time into developing new features in PRO version.
...
* Price per unit is displayed in Cart and Minicart
...
* This feature can now aslo be entered differently for separate variations on variable products
...
**1.9.2**
- Bug fix - General price additional text on wrong position
- Announcement: Starting this release no new features will be created in free version, only bugfixes.

**1.9.1**
- Links to PRO version
