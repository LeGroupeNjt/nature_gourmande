                                    ...
                                    if (is_user_logged_in()) {
                                        ...
                                        <?php if ($myaccount_page_id): ?>
                                            <a class="logout" href="<?php echo esc_url($logout_url); ?>">
                                                <?php echo esc_html_e('Se Deconnecter', 'firezy'); ?>
                                            </a>
                                        <?php endif; ?>
                                    <?php } else {
                                        $myaccount_page_id = get_option('woocommerce_myaccount_page_id'); ?>
                                        <?php if ($myaccount_page_id): ?>
                                            <a class="login" href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>">
                                                <?php echo esc_html_e('Se Connecter', 'firezy'); ?>
                                            </a>
                                        <?php endif; ?>
                                    <?php } ?>
                                </div>
										...
										<div class="topbar-link">
											...
											<div class="account-block">
												<span class="account-label">
													<?php
													if ( is_user_logged_in() ) {
													  echo esc_html_e('Se deconnecter','firezy'); 
													}
													else {
													echo esc_html_e('Se connecter','firezy');
													 } ?>
													</span>
													
													<span class="account-contents">
														<?php echo esc_html_e('Mon Compte','firezy'); ?></span></div>
												<div class="topbar-link-wrapper">   
													...
													<?php endif ?>			
															...
															if ( is_user_logged_in() ) {
																...
																<a href="<?php echo esc_url($logout_url); ?>" ><?php echo esc_html_e('Se deconnecter','firezy'); ?></a>
																<?php }
																else { ?>
																<a href="<?php echo  get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php echo esc_html_e('Connection utilisateur ','firezy'); ?></a>
															<?php } ?>  
														...
														<div class="shopping_cart tog" title="<?php esc_attr_e('View your shopping cart', 'firezy'); ?>">
															...
															<div class="cart-price">
																<a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_attr_e('View your shopping cart', 'firezy'); ?>">
																	...
																	<div class="cart-label"><?php echo esc_html_e('Ma Carte','firezy'); ?></div>
