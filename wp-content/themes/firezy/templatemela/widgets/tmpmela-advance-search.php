			...
			<div class="product-search-widget">
				...
				<?php  	
							...
							$all_categories = get_categories( $args ); ?>
								<option value="<?php echo esc_html_e( '', 'firezy' );?>" selected="selected"><?php echo esc_html_e( '
Toutes catégories', 'firezy' ); ?></option>
				...
				<input type="search" class="search-field" placeholder="Recherche de produits…" value="<?php echo esc_attr(get_search_query()); ?>" name="s" title="<?php echo esc_attr_x( 'Search for:', 'label', 'firezy' ); ?>" />
